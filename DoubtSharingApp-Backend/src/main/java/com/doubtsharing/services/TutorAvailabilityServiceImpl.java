...
public class TutorAvailabilityServiceImpl implements TutorAvailabilityService {
    ...
    public void updateLastPingTimeForAvailableTutors() {
    	...
    	List<TutorAvailability> tutorAvailability =  tutorAvailablityRepo.findByOnlineStatus(TutorAvailabilityStatus.AVAILABLE.toString());
    	
    	for(TutorAvailability ta : tutorAvailability) {
    		tutorAvailablityRepo.save(ta);
    	}
